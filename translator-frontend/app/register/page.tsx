...
export default function Register() {
  ...
  const validatePassword = (pwd: string): { valid: boolean; error?: string } => {
    ...
    if (email && pwd.toLowerCase().includes(email.toLowerCase().split('@')[0])) {
      return { valid: false, error: 'Password must not contain your email' };
    }
    if (fullName && pwd.toLowerCase().includes(fullName.toLowerCase())) {
        ...
        <div className="w-full max-w-md">
          <div className="glass-card rounded-2xl p-8 space-y-6">
            <div className="text-center">
              <h1 className="text-4xl font-bold gradient-text mb-2">TranslateAI</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <PasswordStrengthMeter password={password} email={email} fullName={fullName} />
              </div>
